...
public class FirstNameAdapter extends RecyclerView.Adapter<FirstNameAdapter.MyViewHolder> {

    public int mSelectedItem = -1;
    static FirstName selected_firstname=new FirstName();
        ...
        public MyViewHolder(View view) {
            ...
            mRadio.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    selected_firstname=(firstNameList.get(getAdapterPosition()));
                    //Log.e("nameinfna",selected_firstname.getFname());
                    ActivityFirstName xz=new ActivityFirstName();
                    xz.setName(selected_firstname.getFname());
    ...
    public FirstNameAdapter(List<FirstName> firstNameList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        final FirstName movie =firstNameList.get(position);
        holder.name.setText(movie.getFname());
