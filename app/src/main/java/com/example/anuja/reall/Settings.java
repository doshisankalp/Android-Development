...
public String data(boolean flag)
{
    ...
    public void save(){
       ...
       /* AlertDialog.Builder a_builder = new AlertDialog.Builder(Settings.this);
        ...
        mBuilder.setMessage("Settings saved successfully !!!")
                .setCancelable(true);

        Dialog d = mBuilder.create();

        d.getWindow().setGravity(Gravity.CENTER);
        d.getWindow().setBackgroundDrawable(ContextCompat.getDrawable(Settings.this, R.drawable.layout_bgnocorners));
        d.setTitle("Settings");
        d.show();
